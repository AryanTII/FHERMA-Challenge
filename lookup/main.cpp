...
int main(int argc, char *argv[]) {
    ...
    LookUp lookUp(ccLocation, pubKeyLocation, multKeyLocation, rotKeyLocation, inputLocation,
                             indexLocation, outputLocation);
              
    lookUp.eval();
    lookUp.deserializeOutput();
